...
public final class AE2Module implements Module {
    ...
    public void init(IEventBus registryBus) {
        ...
        AE2IntegrationDataComponents.register(registryBus);
    }
    ...
    public void process() {
        ...
        Upgrades.add(AEItems.FUZZY_CARD, AE2IntegrationItems.INFINITY_ME_STORAGE_CELL, 1);
        Upgrades.add(AEItems.VOID_CARD, AE2IntegrationItems.INFINITY_ME_STORAGE_CELL, 1);
        Upgrades.add(AEItems.INVERTER_CARD, AE2IntegrationItems.INFINITY_ME_STORAGE_CELL, 1);
        Upgrades.add(AEItems.EQUAL_DISTRIBUTION_CARD, AE2IntegrationItems.INFINITY_ME_STORAGE_CELL, 1);

        Upgrades.add(AEItems.FUZZY_CARD, AE2IntegrationItems.INFINITY_ME_STORAGE_CELL_BIG, 1);
        Upgrades.add(AEItems.INVERTER_CARD, AE2IntegrationItems.INFINITY_ME_STORAGE_CELL_BIG, 1);
    }
