...
public class MekCompressorRecipeCategory extends BaseRecipeCategory<MekCompressorRecipe> {

    private final GuiSlot input;
    private final GuiSlot output;

    public MekCompressorRecipeCategory(IGuiHelper helper, MekanismJEIRecipeType<MekCompressorRecipe> recipeType, IBlockProvider mekanismBlock) {
    ...
    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, MekCompressorRecipe recipe, @NotNull IFocusGroup focusGroup) {
