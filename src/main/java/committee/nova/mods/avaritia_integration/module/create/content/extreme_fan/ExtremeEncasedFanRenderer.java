...
public class ExtremeEncasedFanRenderer extends KineticBlockEntityRenderer<ExtremeEncasedFanBlockEntity> {
    public ExtremeEncasedFanRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void renderSafe(ExtremeEncasedFanBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
