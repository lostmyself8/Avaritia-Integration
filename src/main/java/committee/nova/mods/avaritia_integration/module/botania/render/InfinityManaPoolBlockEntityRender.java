...
public class InfinityManaPoolBlockEntityRender implements BlockEntityRenderer<InfinityManaPoolBlockEntity> {

    // Overrides for when we call this renderer from a cart
    public static int cartMana = -1;
    public static int cartMaxMana = -1;
    @UnknownNullability
    public static InfinityManaPoolBlock cartBlock;

    private final TextureAtlasSprite waterSprite;
    private final BlockRenderDispatcher blockRenderDispatcher;

    public InfinityManaPoolBlockEntityRender(BlockEntityRendererProvider.Context ctx) {
    ...
    public void render(@Nullable InfinityManaPoolBlockEntity pool, float partialTick, PoseStack ms, MultiBufferSource buffers, int light, int overlay) {
        ...
        if (pool != null) {
            ...
            InfinityManaPoolBlock block = (InfinityManaPoolBlock) state.getBlock();
            ...
            InfinityManaPoolBlock block = cartBlock;
            ...
            mana = cartMana;
            maxMana = cartMaxMana == -1 ? InfinityManaPoolBlock.MAX_MANA : cartMaxMana;
        }
