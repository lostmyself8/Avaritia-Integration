...
import committee.nova.mods.avaritia_integration.module.thermal_expansion.util.AugmentUtils;
...
public final class ThermalExpansionIntegrationItems {
    ...
    public static final RegistryObject<AugmentItem> CREATIVE_INTEGRAL_COMPONENTS = register("creative_integral_components", AugmentUtils.CREATIVE_INTEGRAL_COMPONENTS);
