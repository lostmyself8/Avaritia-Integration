...
public class CIStress extends ConfigBase {
    ...
    public static <B extends Block, P> NonNullUnaryOperator<BlockBuilder<B, P>> setImpact(double value) {
        return builder -> {
            assertFromAvaritiaIntegration(builder);
            ResourceLocation id = AvaritiaIntegration.rl(builder.getName());
    ...
    private static void assertFromAvaritiaIntegration(BlockBuilder<?, ?> builder) {
        if (!builder.getOwner().getModid().equals(AvaritiaIntegration.MOD_ID)) {
            throw new IllegalStateException("Non-AvaritiaIntegration blocks cannot be added to AvaritiaIntegration's config.");
        }
    }
