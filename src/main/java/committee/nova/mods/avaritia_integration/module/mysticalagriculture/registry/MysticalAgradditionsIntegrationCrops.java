...
public class MysticalAgradditionsIntegrationCrops {
    public static final Crop BLAZE_CUBE = new Crop(AvaritiaIntegration.rl("blaze_cube"), CropTier.FIVE, CropType.RESOURCE, LazyIngredient.tag("forge:storage_blocks/blaze_cube"));
