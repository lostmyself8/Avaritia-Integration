...
public class ChemicalToItemCachedRecipe<INPUT, OUTPUT, RECIPE extends MekanismRecipe & Predicate<INPUT>> extends OneInputCachedRecipe<INPUT, OUTPUT, RECIPE> {
    ...
    public static ChemicalToItemCachedRecipe<@NotNull GasStack, @NotNull ItemStack, GasStackToItemStackRecipe> gasToItem(GasStackToItemStackRecipe recipe,
                                                                                                                         BooleanSupplier recheckAllErrors, IInputHandler<@NotNull GasStack> inputHandler, IOutputHandler<@NotNull ItemStack> outputHandler) {
        return new ChemicalToItemCachedRecipe<>(recipe, recheckAllErrors, inputHandler, outputHandler, recipe::getInput, recipe::getOutput, GasStack::isEmpty,
                ItemStack::isEmpty);
    }
}
