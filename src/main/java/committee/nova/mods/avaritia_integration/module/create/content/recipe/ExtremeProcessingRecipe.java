...
public abstract class ExtremeProcessingRecipe<T extends Container> implements Recipe<T> {
    ...
    public ExtremeProcessingRecipe(IRecipeTypeInfo typeInfo, ExtremeProcessingRecipeBuilder.ProcessingRecipeParams params) {
    ...
    private void validate(ResourceLocation recipeTypeId) {
        ...
        Logger logger = AvaritiaIntegration.LOGGER;
