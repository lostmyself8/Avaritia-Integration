...
import committee.nova.mods.avaritia_integration.module.mekanism.common.recipe.serializer.MekCompressorRecipeSerializer;
...
public class MekIntegrationRecipeSerializers {
    ...
    public static final RecipeSerializerRegistryObject<MekCompressorRecipe> MEK_COMPRESSOR = RECIPE_SERIALIZERS.register("compressor", () -> new MekCompressorRecipeSerializer<>(MekCompressorIRecipe::new));
}
