package committee.nova.mods.avaritia_integration.module.mekanism.client.gui.element.tab;

import committee.nova.mods.avaritia_integration.module.mekanism.common.network.to_server.MekIntegrationPacketGuiInteract;
import committee.nova.mods.avaritia_integration.module.mekanism.common.network.to_server.MekIntegrationPacketGuiInteract.MekIntegrationGuiInteraction;
...
public class GuiMISortingTab extends GuiInsetElement<TileEntityMIFactory<?>> {

    public GuiMISortingTab(IGuiWrapper gui, TileEntityMIFactory<?> tile) {
    ...
    public void onClick(double mouseX, double mouseY, int button) {
        Mekanism.packetHandler().sendToServer(new MekIntegrationPacketGuiInteract(MekIntegrationGuiInteraction.AUTO_SORT_BUTTON, dataSource));
    }
}
