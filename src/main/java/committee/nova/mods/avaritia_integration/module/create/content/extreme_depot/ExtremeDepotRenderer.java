...
public class ExtremeDepotRenderer extends SafeBlockEntityRenderer<ExtremeDepotBlockEntity> {
    public ExtremeDepotRenderer(BlockEntityRendererProvider.Context context) {}

    @Override
    protected void renderSafe(ExtremeDepotBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
