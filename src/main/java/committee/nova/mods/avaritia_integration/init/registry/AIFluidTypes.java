...
public class AIFluidTypes {
    public static final DeferredRegister<FluidType> REGISTRY = DeferredRegister.create(ForgeRegistries.Keys.FLUID_TYPES, AvaritiaIntegration.MOD_ID);

    public static final RegistryObject<FluidType> molten_blaze = REGISTRY.register("molten_blaze",
            ()->new BaseFluidType("molten_blaze", new Vector3f(253f/225f,192f/225f,69f/255f),
                    base("molten_blaze").temperature(3300).lightLevel(15)));

    public static final RegistryObject<FluidType> molten_crystal_matrix = REGISTRY.register("molten_crystal_matrix",
    ...
    public static final RegistryObject<FluidType> molten_neutron = REGISTRY.register("molten_neutron",
    ...
    public static final RegistryObject<FluidType> molten_star = REGISTRY.register("molten_star",
    ...
    private static FluidType.Properties base(String name) {
        return FluidType.Properties.create().viscosity(10000).density(2000).descriptionId("fluid.avaritia_integration." + name).sound(SoundActions.BUCKET_FILL, SoundEvents.BUCKET_FILL).
                sound(SoundActions.BUCKET_EMPTY, SoundEvents.BUCKET_EMPTY).canSwim(false).canDrown(false).pathType(BlockPathTypes.LAVA).adjacentPathType(null)
